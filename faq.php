  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="block">
          <h1>FAQ</h1>
          <p>Most obvious questions and their answers for the service providers and their users.</p>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				...
				<p>To know more please read our terms and conditions also.</p>
				<p>Last updated: December 25, 2018</p>
				<p><a href="mailto:support@placeefy.com?Subject=Legal%Issues">support@placeefy.com</a></p>
				<address>
					Placeefy, Technologies. <br>
					Flat No. 401A, Sai Krupa Niwas, <br>
					Mahal, Nagpur -440032
				</address>
			</div>
			<div class="col-md-8">
